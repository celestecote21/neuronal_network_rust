...
impl ImageTrain{
    fn new(file_name: &str, file_name_label: &str) -> Result<ImageTrain, String>{
    ...
    fn load_file(&mut self, file_name: &str, file_name_label: &str) -> Result<u8, String>{
    ...
    fn next_chunk(&mut self, chunk_size: usize) -> Result<Vec<(Vec<f64>, u8)>, i8>{
